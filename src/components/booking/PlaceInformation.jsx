    ...
    return (
        <div className="col-span-3 rounded-xl">
            ...
            <div className="grid grid-cols-2 gap-2 mt-3">
                <div>
                    <img src="/images/dhaka-3.png" alt="" className="w-full" />
                </div>
                <div>
                    <img src="/images/dhaka-4.png" alt="" className="w-full" />
                </div>
            </div>
            <div className="grid grid-cols-3 gap-2 mt-2">
                <div>
                    <img src="/images/dhaka-6.png" alt="" className="w-full" />
                </div>
                <div>
                    <img src="/images/dhaka-2.png" alt="" className="w-full" />
                </div>
                <div>
                    <img src="/images/dhaka-5.png" alt="" className="w-full" />
                </div>
            </div>
            <hr className="mt-4" />
            {/* -------------- transportation --------------- */}
