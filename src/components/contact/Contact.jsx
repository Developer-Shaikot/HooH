    ...
    return (
        <div className="py-8">
            <div className="grid grid-cols-1 lg:grid-cols-2  ">
                ...
                <div className="mt-6 md:mt-0 pr-16">
